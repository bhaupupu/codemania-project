      ...
      >
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          >
            ...
            />
            <style dangerouslySetInnerHTML={{ __html: `@keyframes pulse-blink { 0%,100%{opacity:1} 50%{opacity:0.2} }` }} />
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              <button onClick={() => triggerCinematic('/play')} className="pixel-btn pixel-btn-blue" style={{ textDecoration: 'none' }}>
                ▶ PLAY NOW
              </button>
