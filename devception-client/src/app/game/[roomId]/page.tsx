...
import { PuzzleLockModal } from '@/components/game/PuzzleLockModal';
import { FalseInsightModal } from '@/components/game/FalseInsightModal';
...
export default function GamePage({ params }: Props) {
  ...
  return (
    <div className="pixel-bg h-screen flex flex-col overflow-hidden">
      ...
      <PuzzleLockModal socket={socket} roomCode={roomId} />
      <FalseInsightModal socket={socket} roomCode={roomId} />
