...
import { GameState, MainTestCaseState, PlayerState, ClientPuzzleData, FalseInsightData, SabotageTargetStatus } from "@/types/game";
...
interface GameStore {
  ...
  myColor: string | null;
  isLocked: boolean;
  activePuzzle: ClientPuzzleData | null;
  activeInsight: FalseInsightData | null;
  sabotageStatus: SabotageTargetStatus | null;
  ...
  setActivePuzzle: (puzzle: ClientPuzzleData | null) => void;
  setActiveInsight: (insight: FalseInsightData | null) => void;
  setSabotageStatus: (status: SabotageTargetStatus | null) => void;
...
export const useGameStore = create<GameStore>((set) => ({
  ...
  setSabotageStatus: (sabotageStatus) => set({ sabotageStatus }),
